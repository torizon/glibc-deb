...
test-xfail-tst-fortify-c-lfs-3.test-result = yes
test-xfail-tst-fortify-c-lfs-2.test-result = yes
test-xfail-tst-fortify-c-default-2.test-result = yes
test-xfail-tst-fortify-c-default-3.test-result = yes
test-xfail-tst-fortify-c-nongnu-2.test-result = yes
test-xfail-tst-fortify-c-nongnu-3.test-result = yes
test-xfail-tst-fortify-cc-default-2.test-result = yes
test-xfail-tst-fortify-cc-default-3.test-result = yes
test-xfail-tst-fortify-cc-lfs-2.test-result = yes
test-xfail-tst-fortify-cc-lfs-3.test-result = yes
test-xfail-tst-fortify-cc-nongnu-2.test-result = yes
test-xfail-tst-fortify-cc-nongnu-3.test-result = yes
